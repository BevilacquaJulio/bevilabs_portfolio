...
function PdfPage({ pdf, pageNumber, containerWidth, totalPages }: PdfPageProps) {
  ...
  useEffect(() => {
    ...
    const renderPage = async () => {
      ...
      const scale = Math.min((containerWidth - 2) / baseViewport.width, 2);
...
/** Renderiza o PDF como páginas em canvas, sem toolbar nativa do navegador. */
